...
def scale_bar(ax, length=None, location=(0.5, 0.05), linewidth=3, fontsize=None, textoffset=0, zorder=10, color = 'k'):
    """
    ...
    text = ax.text(sbx + length * 500, sby+textoffset, str(length) + ' km',
                   transform=tmc, color = color, zorder=zorder,
